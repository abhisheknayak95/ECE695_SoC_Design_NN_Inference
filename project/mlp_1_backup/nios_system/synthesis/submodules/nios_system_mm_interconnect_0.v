...
module nios_system_mm_interconnect_0 (
	...
	wire  [109:0] rsp_mux_003_src_data;                                                                                                       // rsp_mux_003:src_data -> dma_0_read_master_agent:rp_data
	...
	wire   [10:0] rsp_mux_004_src_channel;                                                                                                    // rsp_mux_004:src_channel -> dma_0_write_master_agent:rp_channel
	...
	wire          cmd_mux_005_src_valid;                                                                                                      // cmd_mux_005:src_valid -> dma_0_control_port_slave_agent:cp_valid
	wire  [109:0] cmd_mux_005_src_data;                                                                                                       // cmd_mux_005:src_data -> dma_0_control_port_slave_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                                                                      // dma_0_control_port_slave_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [10:0] cmd_mux_005_src_channel;                                                                                                    // cmd_mux_005:src_channel -> dma_0_control_port_slave_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                                                              // cmd_mux_005:src_startofpacket -> dma_0_control_port_slave_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                                                                // cmd_mux_005:src_endofpacket -> dma_0_control_port_slave_agent:cp_endofpacket
	...
	wire  [109:0] dma_0_control_port_slave_agent_rp_data;                                                                                     // dma_0_control_port_slave_agent:rp_data -> router_010:sink_data
	...
	wire          nios2_qsys_0_jtag_debug_module_agent_rp_valid;                                                                              // nios2_qsys_0_jtag_debug_module_agent:rp_valid -> router_012:sink_valid
	wire  [109:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                                                               // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_012:sink_data
	wire          nios2_qsys_0_jtag_debug_module_agent_rp_ready;                                                                              // router_012:sink_ready -> nios2_qsys_0_jtag_debug_module_agent:rp_ready
	wire          nios2_qsys_0_jtag_debug_module_agent_rp_startofpacket;                                                                      // nios2_qsys_0_jtag_debug_module_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          nios2_qsys_0_jtag_debug_module_agent_rp_endofpacket;                                                                        // nios2_qsys_0_jtag_debug_module_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire  [109:0] new_sdram_controller_0_s1_agent_rp_data;                                                                                    // new_sdram_controller_0_s1_agent:rp_data -> router_013:sink_data
	...
	wire   [82:0] router_015_src_data;                                                                                                        // router_015:src_data -> rsp_demux_010:sink_data
	...
	wire          cmd_demux_003_src0_valid;                                                                                                   // cmd_demux_003:src0_valid -> cmd_mux_008:sink2_valid
	wire  [109:0] cmd_demux_003_src0_data;                                                                                                    // cmd_demux_003:src0_data -> cmd_mux_008:sink2_data
	wire          cmd_demux_003_src0_ready;                                                                                                   // cmd_mux_008:sink2_ready -> cmd_demux_003:src0_ready
	wire   [10:0] cmd_demux_003_src0_channel;                                                                                                 // cmd_demux_003:src0_channel -> cmd_mux_008:sink2_channel
	wire          cmd_demux_003_src0_startofpacket;                                                                                           // cmd_demux_003:src0_startofpacket -> cmd_mux_008:sink2_startofpacket
	wire          cmd_demux_003_src0_endofpacket;                                                                                             // cmd_demux_003:src0_endofpacket -> cmd_mux_008:sink2_endofpacket
	wire          cmd_demux_004_src0_valid;                                                                                                   // cmd_demux_004:src0_valid -> cmd_mux_008:sink3_valid
	wire  [109:0] cmd_demux_004_src0_data;                                                                                                    // cmd_demux_004:src0_data -> cmd_mux_008:sink3_data
	wire          cmd_demux_004_src0_ready;                                                                                                   // cmd_mux_008:sink3_ready -> cmd_demux_004:src0_ready
	wire   [10:0] cmd_demux_004_src0_channel;                                                                                                 // cmd_demux_004:src0_channel -> cmd_mux_008:sink3_channel
	wire          cmd_demux_004_src0_startofpacket;                                                                                           // cmd_demux_004:src0_startofpacket -> cmd_mux_008:sink3_startofpacket
	wire          cmd_demux_004_src0_endofpacket;                                                                                             // cmd_demux_004:src0_endofpacket -> cmd_mux_008:sink3_endofpacket
	...
	wire          rsp_demux_008_src2_valid;                                                                                                   // rsp_demux_008:src2_valid -> rsp_mux_003:sink0_valid
	wire  [109:0] rsp_demux_008_src2_data;                                                                                                    // rsp_demux_008:src2_data -> rsp_mux_003:sink0_data
	wire          rsp_demux_008_src2_ready;                                                                                                   // rsp_mux_003:sink0_ready -> rsp_demux_008:src2_ready
	wire   [10:0] rsp_demux_008_src2_channel;                                                                                                 // rsp_demux_008:src2_channel -> rsp_mux_003:sink0_channel
	wire          rsp_demux_008_src2_startofpacket;                                                                                           // rsp_demux_008:src2_startofpacket -> rsp_mux_003:sink0_startofpacket
	wire          rsp_demux_008_src2_endofpacket;                                                                                             // rsp_demux_008:src2_endofpacket -> rsp_mux_003:sink0_endofpacket
	wire          rsp_demux_008_src3_valid;                                                                                                   // rsp_demux_008:src3_valid -> rsp_mux_004:sink0_valid
	wire  [109:0] rsp_demux_008_src3_data;                                                                                                    // rsp_demux_008:src3_data -> rsp_mux_004:sink0_data
	wire          rsp_demux_008_src3_ready;                                                                                                   // rsp_mux_004:sink0_ready -> rsp_demux_008:src3_ready
	wire   [10:0] rsp_demux_008_src3_channel;                                                                                                 // rsp_demux_008:src3_channel -> rsp_mux_004:sink0_channel
	wire          rsp_demux_008_src3_startofpacket;                                                                                           // rsp_demux_008:src3_startofpacket -> rsp_mux_004:sink0_startofpacket
	wire          rsp_demux_008_src3_endofpacket;                                                                                             // rsp_demux_008:src3_endofpacket -> rsp_mux_004:sink0_endofpacket
	...
	wire          dma_0_control_port_slave_agent_rdata_fifo_src_valid;                                                                        // dma_0_control_port_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] dma_0_control_port_slave_agent_rdata_fifo_src_data;                                                                         // dma_0_control_port_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          dma_0_control_port_slave_agent_rdata_fifo_src_ready;                                                                        // avalon_st_adapter_005:in_0_ready -> dma_0_control_port_slave_agent:rdata_fifo_src_ready
	...
	nios_system_mm_interconnect_0_router_012 router_014 (
	...
	nios_system_mm_interconnect_0_cmd_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
