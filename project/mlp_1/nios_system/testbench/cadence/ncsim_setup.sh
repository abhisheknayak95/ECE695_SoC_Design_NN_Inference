...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nn_acc_single_non_burst.sv"                                             -work nn_acc_single_burst_0                                                  -cdslib ./cds_libs/nn_acc_single_burst_0.cds.lib                                                 
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/data_buffer.sv"                                                         -work nn_acc_single_burst_0                                                  -cdslib ./cds_libs/nn_acc_single_burst_0.cds.lib                                                 
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/fp_multiplier.sv"                                                       -work fp_multiplier_0                                                        -cdslib ./cds_libs/fp_multiplier_0.cds.lib                                                       
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/fp_adder.sv"                                                            -work fp_adder_0                                                             -cdslib ./cds_libs/fp_adder_0.cds.lib                                                            
