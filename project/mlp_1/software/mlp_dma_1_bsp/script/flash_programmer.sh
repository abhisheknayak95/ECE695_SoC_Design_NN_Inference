...
#
nios2-flash-programmer "../flash/mnist-nn_generic_tristate_controller_0.flash" --base=0x8800000 --accept-bad-sysid --device=1 --instance=0 '--cable=USB-Blaster on localhost [1-1]' --program --verbose 
