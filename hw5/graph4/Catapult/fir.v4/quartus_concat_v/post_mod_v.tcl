...
if { [llength $syn_module] > 0 } {
  ...
  # ----------------------------------------------
  set_global_assignment -name POST_MODULE_SCRIPT_FILE "quartus_sh:/home/ecegridfs/a/695r48/ece695r/hw5/graph4/Catapult/fir.v4/quartus_concat_v/post_mod_v.tcl"
}
