...
directive set /fir/core/core:rlp/main CSTEPS_FROM {{. == 18} {.. == 0}}
...
directive set /fir/core/core:rlp/main/acc:io_write(out1:rsc.@) CSTEPS_FROM {{.. == 17}}
...
directive set /fir/core/core:rlp/main/MAC:acc#8 CSTEPS_FROM {{.. == 10}}
directive set /fir/core/core:rlp/main/MAC:acc#14 CSTEPS_FROM {{.. == 11}}
directive set /fir/core/core:rlp/main/MAC:acc#17 CSTEPS_FROM {{.. == 11}}
...
directive set /fir/core/core:rlp/main/MAC:acc#7 CSTEPS_FROM {{.. == 12}}
...
directive set /fir/core/core:rlp/main/MAC:acc#6 CSTEPS_FROM {{.. == 14}}
directive set /fir/core/core:rlp/main/MAC:acc#13 CSTEPS_FROM {{.. == 15}}
...
directive set /fir/core/core:rlp/main/MAC:acc#5 CSTEPS_FROM {{.. == 16}}
...
directive set /fir/core/core:rlp/main/MAC:acc#16 CSTEPS_FROM {{.. == 17}}
directive set /fir/core/core:rlp/main/MAC:acc CSTEPS_FROM {{.. == 17}}
directive set /fir/core/core:rlp/main/MAC-16:acc#2 CSTEPS_FROM {{.. == 17}}
