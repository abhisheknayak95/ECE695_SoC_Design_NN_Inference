...
directive set /fir/core/core:rlp/main CSTEPS_FROM {{. == 8} {.. == 0}}
...
directive set /fir/core/core:rlp/main/acc:io_write(out1:rsc.@) CSTEPS_FROM {{.. == 7}}
...
directive set /fir/core/core:rlp/main/MAC:acc#8 CSTEPS_FROM {{.. == 5}}
directive set /fir/core/core:rlp/main/MAC:acc#14 CSTEPS_FROM {{.. == 6}}
directive set /fir/core/core:rlp/main/MAC:acc#17 CSTEPS_FROM {{.. == 6}}
...
directive set /fir/core/core:rlp/main/MAC:acc#7 CSTEPS_FROM {{.. == 5}}
...
directive set /fir/core/core:rlp/main/MAC:acc#6 CSTEPS_FROM {{.. == 6}}
directive set /fir/core/core:rlp/main/MAC:acc#13 CSTEPS_FROM {{.. == 7}}
...
directive set /fir/core/core:rlp/main/MAC:acc CSTEPS_FROM {{.. == 7}}
directive set /fir/core/core:rlp/main/MAC-16:acc#2 CSTEPS_FROM {{.. == 7}}
