...
#include "/package/eda/mg/Catapult_10.3d/Mgc_home/pkgs/ccs_altera/hdl/DIST_1R1W_RBW_trans_rsc.h"
...
public:
  ...
  sc_signal<sc_lv<16> >                                                                          TLS_coeffs_rsc_q;
  ...
  sc_signal<sc_lv<16> >                                                                          TLS_coeffs_rsc_d;
  DIST_1R1W_RBW_trans_rsc<16,5,32 >                                                              coeffs_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , transactor_coeffs("transactor_coeffs", 0, 16, 0)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 46, 46, 0)
    , catapult_monitor_INST("Monitor", clk, true, 46LL, 46LL)
