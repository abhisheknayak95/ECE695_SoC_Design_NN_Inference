...
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(coeffs:rsc.@)#1 CSTEPS_FROM {{.. == 4}}
directive set /fir/core/core:rlp/main/MAC/MAC-2:mul CSTEPS_FROM {{.. == 5}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(coeffs:rsc.@)#3 CSTEPS_FROM {{.. == 2}}
directive set /fir/core/core:rlp/main/MAC/MAC-4:mul CSTEPS_FROM {{.. == 3}}
directive set /fir/core/core:rlp/main/MAC/MAC-5:MAC:mux CSTEPS_FROM {{.. == 2}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:acc#4 CSTEPS_FROM {{.. == 7}}
directive set /fir/core/core:rlp/main/MAC/MAC:acc#7 CSTEPS_FROM {{.. == 7}}
...
directive set /fir/core/core:rlp/main/MAC/MAC-1:mul CSTEPS_FROM {{.. == 2}}
directive set /fir/core/core:rlp/main/MAC/MAC:acc#6 CSTEPS_FROM {{.. == 3}}
directive set /fir/core/core:rlp/main/MAC/MAC-5:acc#1 CSTEPS_FROM {{.. == 7}}
directive set /fir/core/core:rlp/main/MAC/MAC-5:acc#2 CSTEPS_FROM {{.. == 1}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(coeffs:rsc.@)#7 CSTEPS_FROM {{.. == 8}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:acc#8 CSTEPS_FROM {{.. == 11}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:acc#9 CSTEPS_FROM {{.. == 9}}
directive set /fir/core/core:rlp/main/MAC/MAC-9:acc#1 CSTEPS_FROM {{.. == 11}}
