...
//  
//  Running on Linux 695r48@cparch23.ecn.purdue.edu 3.10.0-1160.45.1.el7.x86_64 x86_64 aol
//  
...
go assembly
directive set /fir/core/regs:rsc -MAP_TO_MODULE {[Register]}
directive set /fir/core/SHIFT -UNROLL yes
directive set /fir/core/MAC -UNROLL yes
directive set /fir/core/main -PIPELINE_INIT_INTERVAL 30
go architect
go allocate
