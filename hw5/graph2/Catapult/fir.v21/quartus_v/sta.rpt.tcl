...
puts "-- FMAX finished for design 'fir'"
    ...
    set i_candidates {1 IN {coeffs_rsc_z[*]} coeffs_rsc_z 2 IN {in1_rsc_dat[*]} in1_rsc_dat} 
    set o_candidates {3 OUT {out1_rsc_dat[*]} out1_rsc_dat 1 IN coeffs_rsc_triosy_lz coeffs_rsc_triosy_lz 2 IN in1_rsc_triosy_lz in1_rsc_triosy_lz 3 OUT out1_rsc_triosy_lz out1_rsc_triosy_lz} 
