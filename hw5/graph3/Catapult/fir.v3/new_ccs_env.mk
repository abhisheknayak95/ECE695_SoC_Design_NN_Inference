ifeq "$(CXX_HOME)" ""
CXX_HOME                                             := /package/eda/mg/Catapult_10.3d/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                             := gcc
...
ifeq "$(ModelSim_Path)" ""
ModelSim_Path                                        := /package/eda/mg/questa10.6b/questasim/bin
...
OSCI_SYSTEMC_INCLUDE                                 := /package/eda/mg/Catapult_10.3d/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                     := /package/eda/mg/Catapult_10.3d/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
Quartus_TimingReportingMode                          := base
...
ifeq "$(Quartus_Path)" ""
Quartus_Path                                         := /package/eda/altera/altera17.0/quartus/bin
export Quartus_Path
endif
...
Quartus_ProPath                                      := /package/eda/altera/altera17.0/quartus/bin
...
Altera_QUARTUS_ROOTDIR                               := /package/eda/altera/altera17.0/quartus
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                           := /package/eda/mg/questa10.6b/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                            := 
