...
directive set /fir/core/core:rlp/main/MAC CSTEPS_FROM {{. == 11} {.. == 2}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:mux#13 CSTEPS_FROM {{.. == 2}}
directive set /fir/core/core:rlp/main/MAC/MAC-8:mul CSTEPS_FROM {{.. == 9}}
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(regs:rsc.@)#8 CSTEPS_FROM {{.. == 4}}
directive set /fir/core/core:rlp/main/MAC/MAC:mux#14 CSTEPS_FROM {{.. == 2}}
directive set /fir/core/core:rlp/main/MAC/MAC-9:mul CSTEPS_FROM {{.. == 8}}
directive set /fir/core/core:rlp/main/MAC/MAC:acc#8 CSTEPS_FROM {{.. == 9}}
directive set /fir/core/core:rlp/main/MAC/MAC:acc#10 CSTEPS_FROM {{.. == 10}}
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(regs:rsc.@)#5 CSTEPS_FROM {{.. == 4}}
directive set /fir/core/core:rlp/main/MAC/MAC:mux#15 CSTEPS_FROM {{.. == 2}}
