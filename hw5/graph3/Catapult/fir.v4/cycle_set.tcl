...
directive set /fir/core/core:rlp/main/MAC CSTEPS_FROM {{. == 6} {.. == 2}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:mux#4 CSTEPS_FROM {{.. == 1}}
directive set /fir/core/core:rlp/main/MAC/MAC-4:mul CSTEPS_FROM {{.. == 5}}
directive set /fir/core/core:rlp/main/MAC/MAC:acc#3 CSTEPS_FROM {{.. == 5}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:mux#5 CSTEPS_FROM {{.. == 1}}
