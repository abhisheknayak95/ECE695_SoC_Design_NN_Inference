...
directive set /fir/core/core:rlp/main/MAC CSTEPS_FROM {{. == 7} {.. == 2}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:read_mem(regs:rsc.@)#3 CSTEPS_FROM {{.. == 3}}
...
directive set /fir/core/core:rlp/main/MAC/MAC:mux#8 CSTEPS_FROM {{.. == 2}}
