...
module nios_system_mm_interconnect_0 (
	...
	wire    [7:0] rsp_mux_002_src_channel;                                                                             // rsp_mux_002:src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire  [107:0] cmd_mux_004_src_data;                                                                                // cmd_mux_004:src_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire  [108:0] rleds_s1_agent_rf_source_data;                                                                       // rleds_s1_agent:rf_source_data -> rleds_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] rleds_s1_agent_rsp_fifo_out_data;                                                                    // rleds_s1_agent_rsp_fifo:out_data -> rleds_s1_agent:rf_sink_data
	...
	wire          cmd_mux_005_src_valid;                                                                               // cmd_mux_005:src_valid -> rleds_s1_agent:cp_valid
	wire  [107:0] cmd_mux_005_src_data;                                                                                // cmd_mux_005:src_data -> rleds_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                                               // rleds_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                                             // cmd_mux_005:src_channel -> rleds_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                                       // cmd_mux_005:src_startofpacket -> rleds_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                                         // cmd_mux_005:src_endofpacket -> rleds_s1_agent:cp_endofpacket
	...
	wire  [108:0] gleds_s1_agent_rf_source_data;                                                                       // gleds_s1_agent:rf_source_data -> gleds_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] gleds_s1_agent_rsp_fifo_out_data;                                                                    // gleds_s1_agent_rsp_fifo:out_data -> gleds_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                                               // cmd_mux_006:src_valid -> gleds_s1_agent:cp_valid
	wire  [107:0] cmd_mux_006_src_data;                                                                                // cmd_mux_006:src_data -> gleds_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                                               // gleds_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                                             // cmd_mux_006:src_channel -> gleds_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                                       // cmd_mux_006:src_startofpacket -> gleds_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                                         // cmd_mux_006:src_endofpacket -> gleds_s1_agent:cp_endofpacket
	...
	wire  [107:0] new_sdram_controller_0_s1_agent_rp_data;                                                             // new_sdram_controller_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire          rleds_s1_agent_rp_valid;                                                                             // rleds_s1_agent:rp_valid -> router_008:sink_valid
	wire  [107:0] rleds_s1_agent_rp_data;                                                                              // rleds_s1_agent:rp_data -> router_008:sink_data
	wire          rleds_s1_agent_rp_ready;                                                                             // router_008:sink_ready -> rleds_s1_agent:rp_ready
	wire          rleds_s1_agent_rp_startofpacket;                                                                     // rleds_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          rleds_s1_agent_rp_endofpacket;                                                                       // rleds_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          gleds_s1_agent_rp_valid;                                                                             // gleds_s1_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] gleds_s1_agent_rp_data;                                                                              // gleds_s1_agent:rp_data -> router_009:sink_data
	wire          gleds_s1_agent_rp_ready;                                                                             // router_009:sink_ready -> gleds_s1_agent:rp_ready
	wire          gleds_s1_agent_rp_startofpacket;                                                                     // gleds_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          gleds_s1_agent_rp_endofpacket;                                                                       // gleds_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire    [7:0] cmd_mux_src_channel;                                                                                 // cmd_mux:src_channel -> sram_0_avalon_sram_slave_burst_adapter:sink0_channel
	...
	wire    [7:0] cmd_demux_001_src0_channel;                                                                          // cmd_demux_001:src0_channel -> nios2_qsys_0_data_master_to_sram_0_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire    [7:0] nios2_qsys_0_data_master_to_sram_0_avalon_sram_slave_cmd_width_adapter_src_channel;                  // nios2_qsys_0_data_master_to_sram_0_avalon_sram_slave_cmd_width_adapter:out_channel -> cmd_mux:sink1_channel
	...
	wire    [7:0] rsp_demux_src1_channel;                                                                              // rsp_demux:src1_channel -> sram_0_avalon_sram_slave_to_nios2_qsys_0_data_master_rsp_width_adapter:in_channel
	...
	wire    [7:0] sram_0_avalon_sram_slave_to_nios2_qsys_0_data_master_rsp_width_adapter_src_channel;                  // sram_0_avalon_sram_slave_to_nios2_qsys_0_data_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink0_channel
	...
	wire          rleds_s1_agent_rdata_fifo_src_valid;                                                                 // rleds_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] rleds_s1_agent_rdata_fifo_src_data;                                                                  // rleds_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          rleds_s1_agent_rdata_fifo_src_ready;                                                                 // avalon_st_adapter_005:in_0_ready -> rleds_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                                   // avalon_st_adapter_005:out_0_valid -> rleds_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                                    // avalon_st_adapter_005:out_0_data -> rleds_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                                   // rleds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                                   // avalon_st_adapter_005:out_0_error -> rleds_s1_agent:rdata_fifo_sink_error
	wire          gleds_s1_agent_rdata_fifo_src_valid;                                                                 // gleds_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] gleds_s1_agent_rdata_fifo_src_data;                                                                  // gleds_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          gleds_s1_agent_rdata_fifo_src_ready;                                                                 // avalon_st_adapter_006:in_0_ready -> gleds_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                                   // avalon_st_adapter_006:out_0_valid -> gleds_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                                    // avalon_st_adapter_006:out_0_data -> gleds_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                                   // gleds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                                   // avalon_st_adapter_006:out_0_error -> gleds_s1_agent:rdata_fifo_sink_error
