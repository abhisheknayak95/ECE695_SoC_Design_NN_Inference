...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/CRC_custom_combinational.v"                                             -work crc_CI_combinational_0                                        -cdslib ./cds_libs/crc_CI_combinational_0.cds.lib                                       
