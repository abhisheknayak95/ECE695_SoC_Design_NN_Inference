...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_width_adapter.sv"                                         -work sram_0_avalon_sram_slave_rsp_width_adapter                     -cdslib ./cds_libs/sram_0_avalon_sram_slave_rsp_width_adapter.cds.lib                    
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_address_alignment.sv"                                     -work sram_0_avalon_sram_slave_rsp_width_adapter                     -cdslib ./cds_libs/sram_0_avalon_sram_slave_rsp_width_adapter.cds.lib                    
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                                    -work sram_0_avalon_sram_slave_rsp_width_adapter                     -cdslib ./cds_libs/sram_0_avalon_sram_slave_rsp_width_adapter.cds.lib                    
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_cmd_mux_003.sv"                           -work cmd_mux_003                                                    -cdslib ./cds_libs/cmd_mux_003.cds.lib                                                   
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                            -work cmd_mux_003                                                    -cdslib ./cds_libs/cmd_mux_003.cds.lib                                                   
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                                -work jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo                   -cdslib ./cds_libs/jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo.cds.lib                  
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_slave_agent.sv"                                           -work jtag_uart_0_avalon_jtag_slave_agent                            -cdslib ./cds_libs/jtag_uart_0_avalon_jtag_slave_agent.cds.lib                           
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                                    -work jtag_uart_0_avalon_jtag_slave_agent                            -cdslib ./cds_libs/jtag_uart_0_avalon_jtag_slave_agent.cds.lib                           
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                          -work nios2_qsys_0_data_master_agent                                 -cdslib ./cds_libs/nios2_qsys_0_data_master_agent.cds.lib                                
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_slave_translator.sv"                                      -work jtag_uart_0_avalon_jtag_slave_translator                       -cdslib ./cds_libs/jtag_uart_0_avalon_jtag_slave_translator.cds.lib                      
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                     -work nios2_qsys_0_data_master_translator                            -cdslib ./cds_libs/nios2_qsys_0_data_master_translator.cds.lib                           
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_customins_slave_translator.sv"                                   -work nios2_qsys_0_custom_instruction_master_multi_slave_translator0 -cdslib ./cds_libs/nios2_qsys_0_custom_instruction_master_multi_slave_translator0.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_qsys_0_custom_instruction_master_multi_xconnect.sv"   -work nios2_qsys_0_custom_instruction_master_multi_xconnect          -cdslib ./cds_libs/nios2_qsys_0_custom_instruction_master_multi_xconnect.cds.lib         
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_nios2_qsys_0.v"                                             -work nios2_qsys_0                                                   -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                  
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/crc_CI_multicycle.v"                                                    -work crc_CI_multicycle_0                                            -cdslib ./cds_libs/crc_CI_multicycle_0.cds.lib                                           
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_reset_source.sv"                                          -work nios_system_inst_reset_bfm                                     -cdslib ./cds_libs/nios_system_inst_reset_bfm.cds.lib                                    
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_avalon_clock_source.sv"                                          -work nios_system_inst_clk_bfm                                       -cdslib ./cds_libs/nios_system_inst_clk_bfm.cds.lib                                      
