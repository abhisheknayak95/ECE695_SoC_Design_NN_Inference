...
# ACDS 17.0 595 linux 2021.09.29.17:54:37
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_cmd_mux_004.sv"                           -work cmd_mux_004                                  -cdslib ./cds_libs/cmd_mux_004.cds.lib                                 
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                            -work cmd_mux_004                                  -cdslib ./cds_libs/cmd_mux_004.cds.lib                                 
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/crc_accelerator.v"                                                      -work crc_accelerator_0                            -cdslib ./cds_libs/crc_accelerator_0.cds.lib                           
