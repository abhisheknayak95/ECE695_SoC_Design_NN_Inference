...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_mm_interconnect_0_cmd_mux_004.sv"                           -work cmd_mux_004                                 
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                            -work cmd_mux_004                                 
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/crc_accelerator.v"                                                      -work crc_accelerator_0                           
